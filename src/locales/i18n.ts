...
export const translations: Record<Language, Translations> = {
  hi: {
    ...
    minWithdrawalNote: 'न्यूनतम निकासी सीमा ₹5,000 है। (निकासी विंडो: प्रत्येक माह की 1 से 6 तारीख)',
    withdrawFunds: 'निकासी का अनुरोध करें',
    withdrawalPendingNotice: 'आपकी निकासी का अनुरोध एडमिन के पास लंबित है।',
    withdrawalWindowNote: 'निकासी विंडो: हर महीने की 1 से 6 तारीख के बीच (न्यूनतम राशि ₹5,000)',
    windowOpenBadge: 'निकासी विंडो खुली है (1-6 तारीख)',
    windowClosedBadge: 'निकासी विंडो बंद/लॉक है (1 से 6 तारीख को खुलेगी)',
    windowClosedNotice: 'निकासी अनुरोध केवल प्रत्येक महीने की 1 से 6 तारीख के बीच एडमिन द्वारा अनलॉक होने पर ही स्वीकार किए जाते हैं। कृपया 1 तारीख को पुनः प्रयास करें।',
  ...
  en: {
    ...
    minWithdrawalNote: 'Minimum withdrawal threshold is ₹5,000. (Withdrawal window: 1st to 6th of each month)',
    withdrawFunds: 'Request Withdrawal',
    withdrawalPendingNotice: 'Your withdrawal request is pending admin processing.',
    withdrawalWindowNote: 'Withdrawal window is open from 1st to 6th of every month (Min ₹5,000)',
    windowOpenBadge: 'Withdrawal Window Open (1st - 6th)',
    windowClosedBadge: 'Withdrawal Window Closed/Locked (Opens 1st - 6th)',
    windowClosedNotice: 'Withdrawal requests are processed only between the 1st and 6th of each month when unlocked by Admin. Please submit during the 1st - 6th window.',
